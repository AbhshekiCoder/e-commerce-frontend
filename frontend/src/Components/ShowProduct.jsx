...
function ShowProduct({title, title1}){
  ...
  useEffect(()=>{
      ...
      axios.post(`${url}product_data`, body).then((result)=>{
       ...
       axios.post(`${url}items`, body).then((result1)=>{
       ...
       axios.post(`${url}sizes`, data).then((result2)=>{
   ...
   useEffect( ()=>{
    ...
    let result =   axios.post(`${url}related_items`, body )
     .then((result)=>{
         console.log(result.data);
   ...
   function rating(){
      ...
      function counts(e){
         ...
         let data = {
            ...
            let result2 =   axios.post(`${url}carts1`, data )
            .then((result1)=>{
                  ...
                  let result =   axios.post(`${url}cart`, body )
                  .then((result)=>{
                      console.log(result.data);
       ...
       function adds(e){
        console.log("clicked")
         ...
         let result =   axios.post(`${url}cart_adds`, body )
         .then((result)=>{
             console.log(result.data);
      ...
      function size(e, id, div){
       ...
       //  document.getElementById(sizes).backgroundColor = "white";
         ...
         let result =   axios.post(`${url}size`, body )
         .then((result)=>{
      ...
      function User_intrested(e){
         ...
         let data = {
            ...
            let result2 =   axios.post(`${url}user_intrested1`, data )
            .then((result1)=>{
                  ...
                  let result =   axios.post(`${url}user_intrested`, body )
                  .then((result)=>{
      ...
      useEffect(()=>{
         ...
         let result =   axios.post(`${url}user_intrested2`, body )
         .then((result)=>{
            if(result.data != 0){
               console.log('shghs')
        ...
        useState(()=>{
         ...
         let result =   axios.post(`${url}counts`, body )
         .then((result)=>{
            console.log(result.data);
