...
function Cart(){
    ...
    let payment = async()=>{
      ...
      await axios.post(`${url}carts`, data).then( async(result) =>{
        console.log(result.data);
        ...
        const response = await axios.post(`${url}payment`, body).then((result1)=>{
          ...
          stripe.redirectToCheckout({
           ...
           localStorage.setItem("order", result1.data.data);
